        ...
        return FormSchema::make(__('forms.equipments.create_title'))
            ...
            ->field(
                TextInput::make('internal_reference')
                    ...
                    ->setRules('string|max:250|unique:equipments,internal_reference')
            )
            ->field(
                NumberInput::make('manufacturing_year')
                    ...
                    ->range(1900, 2099)
                    ->setRules('integer|min:1900|max:2099')
            )
            ->field(
            ...
            ->field(
                NumberInput::make('cost_per_hour')
                    ...
                    ->step(0.01)
                    ->min(0)
                    ->setRules('numeric|min:0|max:9999.99')
            );
    }
