...
class StoreServiceOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sector_configs.*.service_types'                 => ['nullable', 'array'],
            'sector_configs.*.service_types.*.id'            => ['required', 'uuid', 'exists:service_types,id'],
            'sector_configs.*.service_types.*.priority'      => ['nullable', Rule::in(['low', 'normal', 'high', 'urgent'])],
            'category_id'                            => ['required', 'uuid', 'exists:service_order_categories,id'],
