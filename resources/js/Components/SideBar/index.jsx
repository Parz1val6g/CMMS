...
export default function Sidebar() {
  const { props: { auth, can, availableRoles, activeRole }, url } = usePage();
  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Sticky footer ───────────────────────────────────── */}
        <div className="shrink-0 mt-auto border-t border-brand-mid/20 py-3">
          {auth?.user && (
            <RoleSwitcher
              ...
              activeRoleLabel={availableRoles?.find((r) => r.name === activeRole)?.label
