        ...
        <div className="w-full max-w-sm">
          <div className="rounded-2xl border-0 bg-white px-6 py-8 shadow-xl dark:bg-gray-800">
            <div className="mb-6 text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 dark:text-white">{t('pages.auth.register.heading')}</h4>
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">{t('pages.auth.register.subtitle')}</p>
            </div>
            ...
            <form onSubmit={submit} noValidate>
              ...
              <div className="mb-4 flex items-start gap-2">
                ...
                <label htmlFor="accept_terms" className="text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <a href="#" className="font-semibold text-indigo-600 no-underline hover:underline dark:text-indigo-400">{t('pages.auth.register.terms_of_service')}</a> and{' '}
                  <a href="#" className="font-semibold text-indigo-600 no-underline hover:underline dark:text-indigo-400">{t('pages.auth.register.privacy_policy')}</a>.
                </label>
              </div>
            ...
            <div className="mt-3 text-center">
              <span className="text-xs font-medium text-gray-500 dark:text-gray-400">{t('pages.auth.register.has_account')}</span>{' '}
