...
class ClientSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Each entry maps to the matching client below (same index).
        // Two location slots per client: [primary, secondary].
        $locationPairs = [
            [
            ...
            [
                ['name' => 'Escritório Central', 'street' => 'Avenida da Europa nº 100',    'postal' => '3500-001', 'landmark' => 'Palácio do Gelo',             'lat' => 40.6610, 'lon' => -7.9090],
                ['name' => 'Filial Sul',         'street' => 'Rua do Mercado nº 78',        'postal' => '3530-003', 'landmark' => 'Junto ao Mercado Municipal',  'lat' => 40.6020, 'lon' => -7.7600],
            ],
            [
                ['name' => 'Sede Social',   'street' => 'Avenida dos Combatentes nº 45',   'postal' => '3530-002', 'landmark' => 'Centro da Cidade',            'lat' => 40.6045, 'lon' => -7.7620],
            ...
            [
                ...
                ['name' => 'Armazém Norte', 'street' => 'Rua da Estação nº 8',             'postal' => '3530-060', 'landmark' => 'Estação de Comboios',          'lat' => 40.6080, 'lon' => -7.7580],
            ],
            [
            ...
            [
                ['name' => 'Sede Social',   'street' => 'Avenida Alberto Sampaio nº 300',   'postal' => '3500-005', 'landmark' => 'Hospital Distrital',          'lat' => 40.6590, 'lon' => -7.9120],
            ...
            [
                ['name' => 'Sede Social',   'street' => 'Avenida D. Duarte nº 120',        'postal' => '3500-009', 'landmark' => 'Zona Nobre',                   'lat' => 40.6660, 'lon' => -7.9140],
            ...
            [
                ...
                ['name' => 'Armazém Sul',   'street' => 'Largo da Igreja Matriz',          'postal' => '3530-004', 'landmark' => 'Igreja Matriz',                'lat' => 40.6050, 'lon' => -7.7630],
            ],
            [
            ...
            [
                ['name' => 'Sede Social',   'street' => 'Rua da Escola nº 15',             'postal' => '3500-030', 'landmark' => 'Escola Secundária',             'lat' => 40.6680, 'lon' => -7.9160],
        ...
        foreach ($clients as $i => $c) {
            ...
            // Seed client locations if parishes are available
